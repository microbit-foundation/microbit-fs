import { addPyCodeToIntelHex, getPyCodeFromIntelHex } from '../upyhex';
...
describe('Inject Python code into Intel Hex string', () => {
  ...
  it('Inject Python code into an Intel Hex string', () => {
    ...
    const output: string = addPyCodeToIntelHex(simpleIntelHex, pyCode);
  ...
  it('Inject Python with present UICR and Start Linear Address record', () => {
    ...
    const output: string = addPyCodeToIntelHex(fullHex.join('\n'), pyCode);
  ...
  it('Fail to inject Python code too large for flash', () => {
    const failCase = () => {
      ...
      const output: string = addPyCodeToIntelHex(simpleIntelHex, fakeCode);
    };
...
describe('Extract Python code from Intel Hex string', () => {
  it('Extract Python code', () => {
    ...
    const result: string = getPyCodeFromIntelHex(intelHex);
